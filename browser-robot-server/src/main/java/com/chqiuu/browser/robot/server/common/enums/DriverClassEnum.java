package com.chqiuu.browser.robot.server.common.enums;
...
public enum DriverClassEnum {
     ...
     */
    MYSQL("MySQL", "com.mysql.cj.jdbc.Driver", "jdbc:mysql://[server]:[port]/[database]?allowMultiQueries=true&serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=UTF-8&useSSL=false&allowPublicKeyRetrieval=true", "select 1"),
